...
console.log('🧪 Starting Serverless Alipay Cashier & Licensing Gateway Automated Tests...');
...
const sampleMsg = "app_id=2021007100687379&biz_content={\"out_trade_no\":\"TEST_001\",\"total_amount\":\"299.00\"}";
...
console.log('✅ BigInt RSA-SHA256 Sign & Verify:', ok ? 'PASSED' : 'FAILED');
